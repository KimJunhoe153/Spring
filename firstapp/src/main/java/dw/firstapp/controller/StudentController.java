...
public class StudentController {
    ...
    public List<Student> getStudents() {
        ...
        students.add(new Student("Steve", "Withe"));
    ...
    @GetMapping("/student/query")  // localhost:8080/student/query?firstName=Tom&lastName=Smith
    public Student studentRequestParam(@RequestParam String firstName, @RequestParam String lastName) {
        return new Student(firstName, lastName);
        // StudentService는 Bean이므로 인스턴화 하지 않는다.
